#include "stdafx.h"
#include "../../include/ui/PPHtmlDrawer.h"
...
void CPPHtmlDrawer::GotoURL(LPCTSTR url, int showcmd /* = SW_SHOW */)
{
    ...
    if ((UINT)result <= HINSTANCE_ERROR) 
	{
        ...
        if (GetRegKey(HKEY_CLASSES_ROOT, _T(".htm"), key) == ERROR_SUCCESS) 
		{
            ...
            if (GetRegKey(HKEY_CLASSES_ROOT,key,key) == ERROR_SUCCESS) 
			{
                ...
                USES_CONVERSION;
				//  [2/20/2009 ken]
				result =::ShellExecute(NULL, _T("open"), _T("iexplore.exe"),key,NULL,showcmd);
