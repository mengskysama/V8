...
//
HZIP UTILITY_API OpenZip(void *z, unsigned int len, DWORD flags);
...
ZRESULT UTILITY_API GetZipItemA(HZIP hz, int index, ZIPENTRY *ze);
ZRESULT UTILITY_API GetZipItemW(HZIP hz, int index, ZIPENTRYW *ze);
...
ZRESULT UTILITY_API FindZipItemA(HZIP hz, const TCHAR *name, bool ic, int *index, ZIPENTRY *ze);
ZRESULT UTILITY_API FindZipItemW(HZIP hz, const TCHAR *name, bool ic, int *index, ZIPENTRYW *ze);
...
ZRESULT UTILITY_API UnzipItem(HZIP hz, int index, void *dst, unsigned int len, DWORD flags);
...
// Returns:     ZRESULT - ZR_OK if success, otherwise some other value
//
ZRESULT UTILITY_API CloseZip(HZIP hz);
// CloseZip - the zip handle must be closed with this function.

unsigned int UTILITY_API FormatZipMessage(ZRESULT code, char *buf,unsigned int len);
...
HZIP UTILITY_API OpenZipU(void *z,unsigned int len,DWORD flags);
ZRESULT UTILITY_API CloseZipU(HZIP hz);
unsigned int UTILITY_API FormatZipMessageU(ZRESULT code, char *buf,unsigned int len);
bool UTILITY_API IsZipHandleU(HZIP hz);
