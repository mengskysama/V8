...
/** \addtogroup Constructors */ //@{
	...
	CxImage(const WCHAR * filename, DWORD imagetype);
...
/** \addtogroup Painting */ //@{
	...
	long    DrawStringW(HDC hdc, long x, long y, const WCHAR* text, RGBQUAD color, const WCHAR* font, long lSize=0, long lWeight=400, BYTE bItalic=0, BYTE bUnderline=0, bool bSetAlpha=false);
	// <VATI> extensions
...
/** \addtogroup Decode */ //@{
	...
	// For UNICODE support: char -> TCHAR
	bool LoadW(const WCHAR* filename, DWORD imagetype=0);
...
/** \addtogroup Encode */ //@{
	...
	// For UNICODE support: char -> TCHAR
	bool SaveW(const WCHAR* filename, DWORD imagetype);
