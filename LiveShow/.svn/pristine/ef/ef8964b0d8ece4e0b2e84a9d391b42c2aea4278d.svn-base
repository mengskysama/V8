...
#else
#define ER_EXPORT __declspec(dllimport)
#endif

class ER_EXPORT CMailMsg  
{
public:
	CMailMsg();
	virtual ~CMailMsg();
...
ER_EXPORT BOOL SendReportMail(LPCTSTR szTo, LPCTSTR szSubject ,LPCTSTR lpcszFile, LPCTSTR lpcszEmail, LPCTSTR lpcszDesc);
